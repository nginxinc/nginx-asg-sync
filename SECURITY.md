...
We advise users to use the most recent release of the NGINX Plus Integration with Cloud Autoscaling. Support from the
NGINX Professional Services Team is available.
